namespace Breaknes
{
	partial class FormVirtualNESController
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			checkBox8.Location = new Point(297, 61);
			...
			checkBox7.Location = new Point(258, 61);
			...
			checkBox6.Location = new Point(188, 71);
			...
			checkBox5.Location = new Point(134, 71);
			...
			checkBox4.Location = new Point(47, 71);
			...
			checkBox3.Location = new Point(84, 43);
			...
			checkBox1.Location = new Point(47, 12);
			...
			Name = "FormVirtualNESController";
			Text = "Virtual NES Controller";
			ResumeLayout(false);
			PerformLayout();
		}
