...
namespace Breaknes
{
	public partial class FormBindingNESController : Form
	{
		...
		public FormBindingNESController(IOConfigDevice device, IOProcessor io)
		{
			InitializeComponent();
			this.io = io;
			this_device = device;
		...
		private void FormBindingNESController_Load(object sender, EventArgs e)
		{
		...
		private void PopulateActuatorsList()
		{
			...
			int handle = BreaksCore.IOCreateInstance(0x00000003);
			if (handle >= 0)
			{
